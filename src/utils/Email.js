...
export const sendPwRecover = async (
    ...
    const htmlbody = htmlTemplateRecoverPw(user);
    
    return Axios.post(`${BACKENDHOST}sendPwRecover`, {
        destinatarios,
        assunto: 'FollowSoccer, recuperação de senha',
        htmlbody,
        anexos
    })
...
const htmlTemplateRecoverPw = (user) => (
    `
        ...
        <head>
            ...
            <title>Recuperação de senha para o aplicativo FollowSoccer</title>
            ...
            <tr>
                ...
                <table class="email-content" width="100%" cellpadding="0" cellspacing="0">
                    ...
                    <td class="email-masthead">
                        <a href="https://szsolucoes.com.br" class="email-masthead_name">
                FollowSoccer
            </a>
                    </td>
                    </tr>
                            ...
                            https://litmus.com/blog/a-guide-to-bulletproof-buttons-in-email-design -->
                                    ...
                                    <tr>
                                        ...
                                        <table border="0" cellspacing="0" cellpadding="0">
                                            <tr>
                                            <td>
                                                <h2>Sua nova senha: ${user.newPw}</h2>
                                                <br>
                                            </td>
                                            </tr>
                                        </table>
                    ...
                    <td>
                        ...
                        <tr>
                            ...
                            <p class="sub align-center">&copy; 2019 FollowSoccer. Todos os direitos reservados.</p>
                            <p class="sub align-center">
                                SZ Soluções
                                <br>R. Ottokar Doerffel, 639 - 1º Andar, SL 07
                                <br>Anita Garibaldi, Joinville/SC
                            </p>
                            </td>
                        </tr>
                        </table>
